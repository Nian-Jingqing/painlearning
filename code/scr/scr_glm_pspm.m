%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Analyse SCR using PsPM for Zoey's data
% @ 2019, MP Coll
% Take the output from fear_scr_import.py and model SCR responses
% using PsPM toolbox.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Get files path
p.rawpath = '/media/mp/lxhdd/2020_painlearning/derivatives';
p.outpath = '/media/mp/lxhdd/2020_painlearning/derivatives';
