function [logp, yhat, res] = HGF_sa1hat_sa2hat_sa3hat(r, infStates, ptrans)
...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
% predscr = be0 + be1*m1hreg + be2 .* bernv + be3 .* inferv + be4 .* pv;
predscr = be0  + be1 .* bernv + be2 .* inferv + be3 .* pv;
