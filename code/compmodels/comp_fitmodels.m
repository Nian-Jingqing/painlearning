...
p.customfuncpath = ['/home/mp/gdrive/projects/'...
                    '2020_painlearning/code/computational_models/'];

% Ouput path
m.path = '/media/mp/lxhdd/2020_painlearning/derivatives/computational_models';
if ~exist(m.path, 'dir')
   mkdir(m.path)
end
...
print(fullfile(path, 'Model_comparison.png'),...
    '-dpng', p.resolution)
save(fullfile(path, 'VBA_model_comp'), 'posterior', 'out')
close;
figure;
L_plot = L';
