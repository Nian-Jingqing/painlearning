function c = HGF_2levels_intercue_config_sim
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% SAYS 3 but 3rd level is set to infinite precision so does not count.
% See toolbox github page
c.n_levels = 3;
...
c.prc_fun = @HGF_2levels_intercue;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @HGF_2levels_intercue_transp;
